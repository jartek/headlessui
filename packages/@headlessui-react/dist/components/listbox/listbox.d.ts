...
export declare function Listbox<TTag extends ElementType = typeof DEFAULT_LISTBOX_TAG, TType = string | Array<string>>(props: Props<TTag, ListboxRenderPropArg, 'value' | 'onChange'> & {
    value: TType;
